...
class ModelCatalogProduct extends Model {
	...
	public function getProductPreviews($product_id) {
	...
	public function getAllProducts() {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product ORDER BY `sku` DESC");
		return $query->rows;
	}
	
	public function getSomeProducts($start, $limit) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product ORDER BY `sku` DESC LIMIT $start, $limit");
		return $query->rows;
	}
	
	public function getProductsByColor($data = array()) {
		$start = $data['start'];
		$limit = $data['limit'];
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_attribute WHERE `text` LIKE '%" . $data['color'] . "%' AND `language_id` = 1 ORDER BY `product_id` ASC LIMIT $start, $limit");
		return $query->rows;
	}
	
	public function getAllProductsByColor($color) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_attribute WHERE `text` LIKE '%" . $color . "%' AND `language_id` = 1");
		return $query->rows;
	}
	...
	public function getProductName($product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_description WHERE `product_id` = '$product_id' AND `language_id` = 1 LIMIT 1");
		return $query->row;
	}
	
	public function getProductCategoryId($product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_to_category WHERE `product_id` = '$product_id' AND `main_category` = 1 LIMIT 1");
		return $query->row;
	}
	
	public function getProductCategory($category_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_description WHERE `category_id` = '$category_id' AND `language_id` = 1 LIMIT 1");
		return $query->row;
	}
