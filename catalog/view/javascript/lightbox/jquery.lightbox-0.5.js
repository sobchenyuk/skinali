...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'catalog/view/javascript/lightbox/images/ru_RU/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'catalog/view/javascript/lightbox/images/ru_RU/prevlabel.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'catalog/view/javascript/lightbox/images/ru_RU/nextlabel.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'catalog/view/javascript/lightbox/images/ru_RU/closelabel.gif',		// (string) Path and the name of the close btn
			imageBlank:				'catalog/view/javascript/lightbox/images/ru_RU/blank.gif',			// (string) Path and the name of a blank image (one pixel)
