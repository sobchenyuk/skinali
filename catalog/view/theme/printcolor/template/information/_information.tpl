			...
			<div class="sk_gallery_wraper" id="sk_galery">
				...
				<div class="sk_galery_container">
					<div id="sk_galery_container_holder">
						<h4>Кухонные фартуки, скинали - примеры наших работ:</h4>
			
						<div id="wppg-gallery-template-3">
							<?php foreach ($showed_images as $showed_images): ?>
							<?php
								$work_title = substr($showed_images, 2);
								$work_title = substr($work_title, 0, -4);
								$work_title = str_replace("-", " ", $work_title);
							?>
							<div class="wpsg-t3-item">
								<a class="wppg_popup" title="<?=$work_title?>" href="<?=$work_dir . '/' . $showed_images?>" rel="lightbox">
									<img alt="skinali-vinnitsa-2014g-2" src="<?=$work_dir . '/' . $showed_images?>">
								</a>
							</div><!-- end of .wpsg-t3-item -->
							<?php endforeach; ?>
							<div class="clear"></div>
					<!--<div class="wppg_photo_gallery_pagination"><div class="wppg_pagination_prev_next"><span class="wppg_pagination_navigation_links"><a href="https://skinali-printcolor.com/nashi-rabotyi?pagename=nashi-rabotyi&amp;g_page=2">« Previous</a></span><span class="wppg_pagination_text">Displaying Page 3 of 3</span><span class="wppg_pagination_navigation_links"><a href="https://skinali-printcolor.com/nashi-rabotyi?pagename=nashi-rabotyi&amp;g_page=1">Next »</a></span></div></div>            
					-->
					...
					<div class = "sk_order_info">
						...
						<div class = "sk_order_info_right">
							...
							<div class="sk_tags_holder">
								...
								<div class="pluso" data-background="transparent" data-options="medium,round,line,horizontal,counter,theme=06" data-services="vkontakte,odnoklassniki,facebook,twitter,google">
									<div class="pluso-010010011010-06">
										<span class="pluso-wrap" style="background:transparent">
											<a href="<?=$first_post['href']?>" title="ВКонтакте" class="pluso-vkontakte"></a>
											<a href="<?=$first_post['href']?>" title="Одноклассники" class="pluso-odnoklassniki"></a>
