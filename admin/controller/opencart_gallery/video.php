...
class ControllerOpencartGalleryVideo extends Controller { 
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('opencart_gallery/video', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('opencart_gallery/video', 'token=' . $this->session->data['token'] . $url, true),
			'separator' => ' :: '
		);

		$data['opencart_gallery_manager'] = $this->url->link('extension/module/opencart_gallery_manager', 'token=' . $this->session->data['token'], true);

		$data['insert'] = $this->url->link('opencart_gallery/video/insert', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('opencart_gallery/video/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('opencart_gallery/video/edit', 'token=' . $this->session->data['token'] . '&video_id=' . $result['video_id'] . $url, true)
			);
			...
			$data['videos'][] = array(
				...
				'edit'        => $this->url->link('opencart_gallery/video/edit', 'token=' . $this->session->data['token'] . '&video_id=' . $result['video_id'] . $url, true),
				'delete'      => $this->url->link('opencart_gallery/video/delete', 'token=' . $this->session->data['token'] . '&video_id=' . $result['video_id'] . $url, true)
			);
		}
		...
		$pagination->url = $this->url->link('opencart_gallery/video', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('opencart_gallery/video_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['video_id'])) {
			$data['action'] = $this->url->link('opencart_gallery/video/insert', 'token=' . $this->session->data['token'], true);
		} else {
			$data['action'] = $this->url->link('opencart_gallery/video/edit', 'token=' . $this->session->data['token'] . '&video_id=' . $this->request->get['video_id'], true);
		}

		$data['cancel'] = $this->url->link('opencart_gallery/video', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('opencart_gallery/video_form', $data));
	}
