...
class ControllerOpencartGallerySetting extends Controller {
	...
	public function index() {
	   ...
	   $data['tab_newscatpage'] = $this->language->get('tab_newscatpage');
		...
		$data['opencart_gallery_manager'] = $this->url->link('module/opencart_gallery_manager', 'token=' . $this->session->data['token'], true);

		$data['action'] = $this->url->link('opencart_gallery/setting', 'token=' . $this->session->data['token'], true);
		
		$data['cancel'] = $this->url->link('module/opencart_gallery_manager', 'token=' . $this->session->data['token'], true);
